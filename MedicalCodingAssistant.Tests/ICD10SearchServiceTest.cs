...
public class ICD10SearchServiceTest
{
    ...
    /// Sets up a test service with mock results for the free text fallback and verifies that the returned results match the expected values.
    ...
    /// Verifies that the method returns an empty result set and that the total SQL result count is zero.
    /// </summary>
    /// <returns></returns>
    [TestMethod]
    ...
    /// Verifies that the method clamps the results to the maximum allowed value and returns the correct number of results.
    /// </summary>
    /// <returns></returns>
    [TestMethod]
    ...
    /// Verifies that the method returns the correct number of results and that the total SQL result count matches the expected value.
    /// </summary>
    /// <returns></returns>
    [TestMethod]
